...
def QuintaFeira(faq):
    ...
    while True:
        ...
        if entrada_usuario.lower() in ["sair", "tchau", "adeus"]:
            ...
            print("QuintaFeira: Você quer usar comando de voz? Diga o site que deseja abrir.")
            falar("Você quer usar comando de voz? Diga o site que deseja abrir.")
            comando = ouvir_comando()

            if "abra o youtube" in comando:
                print("QuintaFeira: Abrindo o YouTube...")
                falar("Abrindo o YouTube")
                webbrowser.open("https://www.youtube.com")

            elif "pesquisar no youtube" in comando:
                termo_pesquisa = comando.replace("pesquisar no youtube", "").strip()

                if termo_pesquisa:
                    print(f"QuintaFeira: Pesquisando no YouTube por: {termo_pesquisa}")
                    falar(f"Pesquisando no YouTube por {termo_pesquisa}")
                    termo_pesquisa = termo_pesquisa.replace(" ", "+")  # Substituir espaços por '+'
                    webbrowser.open(f"https://www.youtube.com/results?search_query={termo_pesquisa}")

                else:
                    print("QuintaFeira: Não entendi o que você quer pesquisar. Tente novamente.")
                    falar("Não entendi o que você quer pesquisar. Tente novamente.")
                ...
                print("QuintaFeira: Não consegui identificar o site. Tente novamente.")
